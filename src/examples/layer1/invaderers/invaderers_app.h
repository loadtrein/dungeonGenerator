...
namespace octet {
  ...
  public:
    ...
    void render(texture_shader_no_alpha &shader, mat4t &cameraToWorld) {
  ...
  class invaderers_app : public octet::app {
    ...
    void draw_text(texture_shader_no_alpha &shader, float x, float y, float scale, const char *text) {
      mat4t modelToWorld;
      modelToWorld.loadIdentity();
      modelToWorld.translate(x, y, 0);
